...
<body>
    ...
    /* Uygulama:
       ...
       5- Uygulama: Öğrenci Detayı Dizisini Alt Alta döngüleri kullanarak yazdırınız. */


    //1-rastgele 0-100 arasında üretilen değerin tek veya çift olduğunu ekrana yazdırınız. 
    echo "<h4>Uygulamalar</h4>";
    echo "<h3>1-Rastgele 0-100 arasında üretilen değerin tek veya çift olduğunu ekrana yazdırınız.</h3>";
    $rastgele = rand(0, 100);
    if ($rastgele % 2 == 0) {
    ...
    //2-rastgele 0-100 arasında üretilen değerin 50'den küçük olduğu durumlarda kaldınız, büyükse geçtiniz yazdırınız
    echo "<h3>2-Rastgele 0-100 arasında üretilen değerin 50'den küçük olduğu durumlarda kaldınız, büyükse geçtiniz yazdırınız</h3>";
    $rastgele = rand(0, 100);
    if ($rastgele >= 50) {
    ...
    //3-doğum yılına göre 18 yaşından büyük olanların ehliyet alabileceğini kontrol eden if bloğunu yazınız.  
    echo "<h3>3-Doğum yılına göre 18 yaşından büyük olanların ehliyet alabileceğini kontrol eden if bloğunu yazınız.</h3>";
    $dogumyili = rand(1970, 2020);
    echo " Doğum yılınız: $dogumyili";
    ...
    //4-Öğrenci Detayları Dizisindeki Her Öğrencinin Detaylarını Alt Alta yazdırınız. 
    echo "<h3>4-Öğrenci Detayları Dizisindeki Her Öğrencinin Detaylarını Alt Alta yazdırınız.</h3>";
    ...
    //5- Uygulama: Öğrenci Detayı Dizisini Alt Alta döngüleri kullanarak yazdırınız. 
    echo "<h3>5-Öğrenci Detayı Dizisini Alt Alta döngüleri kullanarak yazdırınız.</h3>";
